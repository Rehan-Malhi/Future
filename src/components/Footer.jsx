...
export default function Footer() {
  return (
    <>
      <footer className="flex-col flex lg:flex-row justify-center items-center relative z-10 mt-2 border-t border-[#FF7A00]/25 bg-[#30318B]">
        {/* top brand glow line */}
        ...
        <div className="ml-76 px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
