...
export default function ProductSlugPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // ✅ Selected image (defaults to product.image)
  ...
  // ✅ thumbs list (fallback safe)
  const thumbs =
    product?.thumbnails?.length ? product.thumbnails : product?.image ? [product.image] : [];

  // Avoid rendering Next/Image with empty src during initial load
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-16">
          ...
          <aside className="w-full space-y-6">
            ...
            {/* ✅ 3 Headings + 3 Descriptions */}
            <div className="rounded-2xl border border-black/10 bg-white p-4">
              <h2 className="text-sm font-semibold text-[#30318B]">
              ...
              <div className="mt-4 space-y-4">
                {(product?.highlights || []).map((item, i) => (
                  ...
                  >
                    <h3 className="text-base font-semibold text-[#30318B]">
                      {item.heading}
                    </h3>
            ...
            <div className="rounded-2xl border border-black/10 bg-white p-4">
              ...
              <p className="mt-3 text-xs text-black/70">
                Share your quantity, sizes, logos and colorway. We’ll reply with
